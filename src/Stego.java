...
class Stego {
  ...
  public void encode(){
    ...
    //System.out.println("Encryption time taken"+(endTime-startTime));
    System.out.println("Encryption time taken :"+TimeUnit.MILLISECONDS.convert(endTime-startTime, TimeUnit.NANOSECONDS)+" mili sec");
  }//encode
  ...
  public boolean decode(){
    ...
    long endTime=System.nanoTime();
    System.out.println("Decryption time taken :"+TimeUnit.MILLISECONDS.convert(endTime-startTime, TimeUnit.NANOSECONDS)+" mili sec");
    return success;
  }//decode
  ...
  private boolean possible(String pt) {
    ...
    if ( cipherbuff.length*8 >  audioBytes.length)
      {System.out.println(cipherbuff.length*8+" "+audioBytes.length);
    	return false;}
    else
      return true;
    }catch(Exception e){
